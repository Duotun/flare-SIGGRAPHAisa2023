...
Please take care the following things to set up succesfully

- Use the following command from the official tinycudnn website to install the tinycudnn package with Pytorch Extensions
  1) https://github.com/NVlabs/tiny-cuda-nn
  2) pip install git+https://github.com/NVlabs/tiny-cuda-nn/#subdirectory=bindings/torch

- pip install configargparse open3d
- Change "change imageio.imread(fn, as_gray=True)" to "change imageio.imread(fn, mode='F')"
- Install robust_loss_pytorch
  1) https://github.com/jonbarron/robust_loss_pytorch
  2) https://blog.csdn.net/qq_39784222/article/details/123680754
